<template>
  <div class="order-item">
    <div class="head">
      ...
      <!-- [5,6].includes(order.orderState)  order.orderState为5或6 为true -->
    ...
    <div class="body">
      ...
      <div class="column action">
        ...
        <p><a @click="$router.push(`/member/checkout?orderId=${order.id}`)" v-if="[2,3,4,5].includes(order.orderState)" href="javascript:;">再次购买</a></p>
